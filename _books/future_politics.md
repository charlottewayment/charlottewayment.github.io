...
cover: assets/img/book_covers/future_politics.jpg
olid: # use Open Library ID to fetch cover (if no `cover` is provided) - e.g. OL43499941M
isbn: # use ISBN to fetch cover (if no `olid` is provided, dashes are optional) - e.g. 7539967447
categories: nonfiction politics governance ethics society
tags: politics
buy_link: https://www.worldofbooks.com/en-gb/search?q=Future%20Politics
date: 2026-04-05
started: 
finished: 
released: 2018
stars: 
goodreads_review: 
status: queued  # 'abandoned,finished,interested,paused,queued,reading,reread' NOTE: CAPITALISAATION IS IMPORTANT
---
